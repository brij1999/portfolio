...
class Landing extends Component {
	render() {
		// prettier-ignore
		const icons = [icon01,icon02,icon03,icon04,icon05,icon06,icon07,icon08,icon09,icon10,icon11,icon12,icon13,icon14,icon15];
		let angle = 360 - 90;
			...
			<div className='landing'>
				<div className='landing__side'>
					<div className='landing__side__linkgrp'>
						<a href='https://github.com/brij1999/' target='_blank' className='landing__side__linkgrp--link'>
							GitHub
						</a>
						<a
				...
				<div className='landing__hero'>
					<div className='landing__hero__text'>
						...
						<div className='landing__hero__desc'>
							...
							<div>knowledge in all the stages of the software development lifecycle.</div>
							<div>I like to design and develop web-apps, automate stuff with IoT,</div>
